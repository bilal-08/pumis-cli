...
const getPayload = async () => {
    const res = await axios.get('https://ums.paruluniversity.ac.in/Login.aspx',{httpsAgent:new https.Agent({secureOptions:crypto.constants.SSL_OP_LEGACY_SERVER_CONNECT})}).catch((x) => x)
